...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item">
      <a class="nav-link" href="Admin_KH.jsp" style="color: white;">Khách hàng</a>
    </li>
    <li class="nav-item active">
    ...
    <li class="nav-item">
      <a class="nav-link disabled" href="Admin_ND.jsp">Người dùng</a>
			...
			<div id="right" style="padding: 10px;">
				<h3 style="color: #C00000;">QUẢN LÍ KHÁCH HÀNG</h3>
                <hr />
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="form-group row">
                                  <label for="MaKH" class="col-sm-2 col-form-label">Mã khách hàng</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" id="MaKH" placeholder="Mã khách hàng" required>
                                  </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="DiaChi" class="col-sm-2 col-form-label">Giá</label>
                                    <div class="col-sm-10">
                                      <input type="number" class="form-control" id="DiaChi" placeholder="Địa chỉ" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="SoDT" class="col-sm-2 col-form-label">Số điện thoại</label>
                                    <div class="col-sm-10">
                                      <input type="number" class="form-control" id="SoDT" placeholder="Số điện thoại" required>
                                    </div>
                                </div>
                      ...
                      <div class="modal-body">
                            <form>
                                <div class="form-group row">
                                  <label for="MaKH" class="col-sm-2 col-form-label">Mã khách hàng</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" id="MaKH" placeholder="Mã khách hàng" required readonly>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="TenKH" class="col-sm-2 col-form-label">Tên khách hàng</label>
