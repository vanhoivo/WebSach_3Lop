  ...
  <div class="col-md-offset-4 col-md-4" id="box"> 
   ...
   <form class="form-horizontal" action="Login.html" method="get"  id="login_form"> 
    <fieldset> 
     ...
     <div class="form-group"> 
      <div class="col-md-12"> 
       <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span> <input name="email" placeholder="Re-Enter Password" class="form-control" type="text"> 
       </div> 
      </div> 
     </div>
     <div class="form-group"> 
