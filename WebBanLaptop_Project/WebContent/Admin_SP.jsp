    ...
    <li class="nav-item">
      <a class="nav-link disabled" href="Admin_ND.html">Người dùng</a>
			...
			<div id="right" style="padding: 10px;">
				<h3 style="color: #C00000;">QUẢN LÍ SẢN PHẨM</h3>
                <hr />
                                ...
                                <table class="table table-striped table-hover border border-primary">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <td>0930</td>
                                            <td>1</td>
                                            <td><i class="fas fa-check-circle"></i> <i class="fas fa-trash-alt"></i> <i class="fas fa-edit"></i></td>
                                        </tr>
                                          <tr>
                                                <td>0</td>
                                                <td>SP00</td>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="form-group row">
                                    <label for="DonGia" class="col-sm-2 col-form-label">Giá</label>
                                    <div class="col-sm-10">
                                      <input type="number" class="form-control" id="DonGia" placeholder="Giá" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                      ...
                      <div class="modal-body">
                          <form>
                              <div class="form-group row">
                                <label for="MaSP" class="col-sm-2 col-form-label">Mã sản phẩm</label>
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="MaSP" placeholder="Mã sản phẩm" readonly>
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="TenSP" class="col-sm-2 col-form-label">Tên sản phẩm</label>
