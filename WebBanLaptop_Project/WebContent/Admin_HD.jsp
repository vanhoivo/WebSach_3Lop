    ...
    <li class="nav-item">
      <a class="nav-link" href="Admin_SP.jsp">Sản phẩm</a>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
          <a class="dropdown-item active" href="Admin_HD.jsp">Hóa đơn</a>
          <div class="dropdown-divider"></div>
    ...
    <li class="nav-item">
      <a class="nav-link disabled" href="Admin_ND.jsp">Người dùng</a>
			...
			<div id="right" style="padding: 10px;">
				<h3 style="color: #C00000;">QUẢN LÍ HÓA ĐƠN</h3>
                <hr />
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="number" class="form-control" id="MaKH" placeholder="Mã khách hàng" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="NgayLap" class="col-sm-2 col-form-label">Ngày lập</label>
                                    <div class="col-sm-10">
                                      <input type="date" class="form-control" id="NgayLap" placeholder="Ngày lập" required>
                                    </div>
                                </div>
