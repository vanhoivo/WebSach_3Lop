    ...
    <li class="nav-item">
      <a class="nav-link disabled" href="Admin_ND.html">Người dùng</a>
			...
			<div id="right" style="padding: 10px;">
				<h3 style="color: #C00000;">QUẢN LÍ NHÂN VIÊN</h3>
                <hr />
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="form-group row">
                                  <label for="MaNV" class="col-sm-2 col-form-label">Mã nhân viên</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" id="MaNV" placeholder="Mã nhân viên" required>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="TenNV" class="col-sm-2 col-form-label">Tên nhân viên</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" id="TenNV" placeholder="Tên sản phẩm" required>
                                  </div>
                                </div>
                                <div class="form-group row">
                                    <label for="LuongCB" class="col-sm-2 col-form-label">Lương cơ bản</label>
                                    <div class="col-sm-10">
                                      <input type="number" class="form-control" id="LuongCB" placeholder="Lương cơ bản" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="PhuCap" class="col-sm-2 col-form-label">Phụ cấp</label>
                                    <div class="col-sm-10">
                                      <input type="number" class="form-control" id="PhuCap" placeholder="Phụ cấp" required>
                                    </div>
                                </div>
                      ...
                      <div class="modal-body">
                            <form>
                                <div class="form-group row">
                                  <label for="MaNV" class="col-sm-2 col-form-label">Mã nhân viên</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" id="MaNV" placeholder="Mã nhân viên" required readonly>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="TenNV" class="col-sm-2 col-form-label">Tên nhân viên</label>
