...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item">
      <a class="nav-link disabled" href="Admin_ND.jsp" style="color: white;">Người dùng</a>
    </li>
  </ul>
			</div>
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="form-group row">
                                  <label for="TenND" class="col-sm-2 col-form-label">Tên người dùng</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" id="TenND" placeholder="Tên người dùng" required>
                                  </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="Cap" class="col-sm-2 col-form-label">Cấp bậc</label>
                                    <div class="col-sm-10">
                                      <input type="number" class="form-control" id="Cap" placeholder="Cấp bậc" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="GhiChu" class="col-sm-2 col-form-label">Ghi chú</label>
                                    <div class="col-sm-10">
                                      <input type="number" class="form-control" id="GhiChu" placeholder="Ghi chú">
                                    </div>
                                </div>
                      ...
                      <div class="modal-body">
                            <form>
                                <div class="form-group row">
                                  <label for="TenND" class="col-sm-2 col-form-label">Tên người dùng</label>
                                  <div class="col-sm-10">
                                    <input type="text" class="form-control" id="TenND" placeholder="Tên người dùng" required readonly>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="MatKhau" class="col-sm-2 col-form-label">Mật khẩu</label>
